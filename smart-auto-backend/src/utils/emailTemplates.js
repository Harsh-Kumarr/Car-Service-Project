...
export const resetPasswordTemplate = (name, link) =>
  emailWrapper(`
    ...
    <p style="margin:0 0 24px; color:#64748b; font-size:15px; line-height:1.6;">
      ...
      We received a request to reset your password for your AutoAI account. Click the button below to choose a new password. This link will expire in <strong>10 minutes</strong>.
    </p>

    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:28px 0;">
      <tr>
        <td align="center">
          <a href="${link}" target="_blank" style="display:inline-block; background-color:#2563eb; color:#ffffff; font-size:15px; font-weight:700; text-decoration:none; padding:14px 32px; border-radius:8px; box-shadow:0 4px 12px rgba(37,99,235,0.2);">
            Reset Password
          </a>
        </td>
      </tr>
